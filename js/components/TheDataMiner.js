...
// params is the obj we're passing in that contains an id or another bit of data.
// it looks like this: {id: 1} or { id:1, name:"Trevor", role: "prof"} =>
// needs to become this: id=1&&name=Trevor
function getData(params, cb) { //getData(null, buildTeam)
  ...
  if ( params ) { 
    ...
    baseURL += `?${newQStringParams}`; //./includes/index.php?id=1
  }
